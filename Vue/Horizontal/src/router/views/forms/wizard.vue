        ...
        <div class="card">
          <div class="card-body">
            ...
            <form-wizard color="#6658dd">
              <tab-content title="Account" icon="mdi mdi-account-circle">
                <div class="row">
                  <div class="col-12">
              ...
              <tab-content title="Profile" icon="mdi mdi-face-profile">
                <div class="row">
                  <div class="col-12">
                    <div class="form-group row mb-3">
              ...
              <tab-content title="Finish" icon="mdi mdi-checkbox-marked-circle-outline">
                <div class="row">
                  <div class="col-12">
