...
!function($) {
    ...
    Dashboard4.prototype.init = function() {
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ["Bitcoin","Litecoin"],['#4b5661'],['#4b5661'], ['#4a81d4', "#4b5661"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#4fc6e1','#6658dd', '#525e6b']);
    },
    //init
