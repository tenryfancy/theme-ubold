...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#4a81d4','#4fc6e1','#525e6b']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ["Bitcoin", "Ethereum", "Litecoin"], ['#02c0ce','#0acf97', '#525e6b']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ["Bitcoin","Litecoin"],['#ffffff'],['#999999'], ['#525e6b', "#6658dd"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#4fc6e1','#6658dd', '#424d58']);
    },
    //init
